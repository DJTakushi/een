...
int main(int argc, char* argv[]) {
  ...
  std::string spb_address = ec::arg_helper::get_spb_address(argc,argv);
  ec::connection_type type = ec::arg_helper::get_connection_type(argc,argv);
  std::string local_address = ec::arg_helper::get_address(argc, argv);
  uint local_port = ec::arg_helper::get_port(argc, argv);
